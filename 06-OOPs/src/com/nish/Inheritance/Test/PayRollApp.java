...
import com.nish.Inheritance.Model.Employee;
import com.nish.Inheritance.Model.FullTimeEmployee;
import com.nish.Inheritance.Model.PartTimeEmployee;
import com.nish.Inheritance.Model.ContractEmployee;
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < n; i++) {
			...
			case 3:
				...
				scanner.nextLine();
				employees[i] = new ContractEmployee(name, empId, fixedAmount, tax);
				break;
